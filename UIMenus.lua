...
function TurtleDungeonTimer:showInstanceList(parentBtn, isDungeonFilter)
    ...
    -- Create Level 2 submenu
    local submenu = self:CreateTDTDropdown(self.frame.categoryMenu, 160, menuHeight)
