...
translations.enUS = {
    ...
    ["PREP_UNOFFICIAL_WARNING"] = "Warning: Not all group members have the addon. This run will not be officially ranked.",
...
translations.deDE = {
    ...
    ["PREP_UNOFFICIAL_WARNING"] = "Warnung: Nicht alle Gruppenmitglieder haben das Addon. Dieser Run wird nicht offiziell gewertet.",
